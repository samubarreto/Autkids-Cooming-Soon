...
const translations = {
  pt: {
    ...
    sec_1_text: "A sua privacidade é prioridade para o Autkids. Esta Política de Privacidade descreve como coletamos, usamos e protegemos as informações dos usuários e crianças que utilizam nosso aplicativo.",
    ...
    sec_4_text: "O Autkids não vende, aluga ou compartilha informações pessoais com terceiros para fins de marketing. Dados anônimos podem ser usados para análises de desempenho internas.",
    ...
    sec_7_text: "Se tiver dúvidas sobre nossa política de privacidade, entre em contato pelo e-mail: <strong><a href='mailto:support@autkids.com'>support@autkids.com</a></strong>",
  ...
  en: {
    ...
    sec_1_text: "Your privacy is a priority for Autkids. This Privacy Policy describes how we collect, use, and protect the information of users and children who use our application.",
    ...
    sec_4_text: "Autkids does not sell, rent, or share personal information with third parties for marketing purposes. Anonymous data may be used for internal performance analysis.",
    ...
    sec_7_text: "If you have questions about our privacy policy, contact us via email: <strong><a href='mailto:support@autkids.com'>support@autkids.com</a></strong>",
  ...
  es: {
    ...
    sec_1_text: "Su privacidad es prioridad para Autkids. Esta Política de Privacidad describe cómo recopilamos, usamos y protegemos la información de los usuarios y niños que utilizan nuestra aplicación.",
    ...
    sec_4_text: "Autkids no vende, alquila ni comparte información personal con terceros con fines de marketing. Se pueden utilizar datos anónimos para análisis de rendimiento internos.",
    ...
    sec_7_text: "Si tiene dudas sobre nuestra política de privacidad, contáctenos por correo: <strong><a href='mailto:support@autkids.com'>support@autkids.com</a></strong>",
