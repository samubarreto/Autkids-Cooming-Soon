...
const translations = {
  pt: {
    ...
    sec_7_text: "Se tiver dúvidas sobre nossa política de privacidade, entre em contato pelo e-mail: <strong><a href='mailto:support@autikids.app'>support@autikids.app</a></strong>",
  ...
  en: {
    ...
    sec_7_text: "If you have questions about our privacy policy, contact us via email: <strong><a href='mailto:support@autikids.app'>support@autikids.app</a></strong>",
  ...
  es: {
    ...
    sec_7_text: "Si tiene dudas sobre nuestra política de privacidad, contáctenos por correo: <strong><a href='mailto:support@autikids.app'>support@autikids.app</a></strong>",
